...
{}********************** Example of use ***********************{}
  ...
  (1) Calculate single amino acid polymorphism of an alignment sequence file:
      SAAPS -i your/sequence/path -cp -o your/output/path

  (2) Calculate and plot single amino acid polymorphism in an alignment sequence file:
      SAAPS -i your/sequence/path -cp -pp -o your/output/path

  Tip: the input(file) and output(directory) is recommended absolute path.

  Above are just the simple examples, detailed instruction in website: {}https://github.com/xiaosheep01/hiscan
...
def starts():
    ...
    print(
        "{}>>> {}Description: Count SAAP in protein sequences.".format(Fore.GREEN, Fore.RESET))

    print("{}>>> {}Version: 0.1 (2024-03-05)".format(Fore.GREEN, Fore.RESET))
